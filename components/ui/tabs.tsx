  ...
  return (
    <TabsPrimitive.Tab
      className={cn(
        ...
        variant === "default" && "data-active:bg-background dark:data-active:bg-input",
        variant === "underline" && "grow-0 rounded-none border-0 px-0 pb-3 mr-6 last:mr-0 bg-transparent hover:bg-transparent hover:text-foreground data-active:font-semibold data-active:border-b-2 data-active:border-primary",
