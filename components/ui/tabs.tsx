  ...
  return (
    <TabsPrimitive.Tab
      className={cn(
        ...
        variant === "underline" && "grow-0 rounded-none border-0 px-0 pb-3 mr-6 last:mr-0 bg-transparent hover:bg-transparent hover:text-foreground data-active:font-semibold",
        variant === "pill" && "rounded-full bg-muted px-4 hover:text-foreground data-active:bg-transparent data-active:text-background data-active:hover:text-background",
        className,
      )}
      data-slot="tabs-tab"
      {...props}
