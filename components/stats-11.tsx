    ...
    if (details && title === "Commands") {
      ...
      return (
        <div className="relative h-1 w-full overflow-hidden rounded-full bg-muted">
          <div
            className="absolute left-0 h-full w-full origin-left bg-success transition-transform duration-200 ease-out"
            style={{ transform: `scaleX(${writesPercentage / 100})` }}
          />
          <div
            className="absolute left-0 h-full w-full origin-left bg-info transition-transform duration-200 ease-out"
            style={{
    ...
    <Card className="relative overflow-hidden">
      <CardContent className="p-4 py-0">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <Button
            variant="ghost"
            className="h-8 w-full rounded-none text-info gap-0 justify-start hover:text-info-base dark:text-info-foreground dark:hover:text-info-dark bg-muted/50"
    ...
    <>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          ...
          details={[
            { label: "Writes", value: "11,276,493", color: "bg-success" },
            { label: "Reads", value: "2,548,921", color: "bg-info" },
          ]}
          actionLabel="Upgrade"
