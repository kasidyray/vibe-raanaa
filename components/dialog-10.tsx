      ...
      <DialogContent className="p-0 sm:max-w-lg gap-0">
        ...
        <form action="#" method="POST">
              ...
              <div className="space-y-2 col-span-2">
                ...
                <Popover>
                  <PopoverTrigger render={<Button id="date" variant={"outline"} className={cn(
                                                        ...
                                                        )} />}><CalendarIcon className="mr-1 h-4 w-4 shrink-0" />{" "}{date ? format(date, "PPP") : <span>Pick a date</span>}</PopoverTrigger>
          ...
          <div className="flex items-center justify-end border-t p-4 space-x-2">
            <DialogClose render={<Button type="button" variant="ghost" />}>Cancel
                                    </DialogClose>
