...
export const components: ComponentMeta[] = [
  ...
  { slug: "switch",       name: "Switch",        description: "Toggle a setting on or off.",                       category: "Inputs" },
  { slug: "select",       name: "Select",        description: "Choose one item from a dropdown list.",             category: "Inputs" },
